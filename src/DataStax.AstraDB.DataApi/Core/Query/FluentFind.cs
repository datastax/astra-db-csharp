...
// public class FluentFind<T, TId, TResult, TSort> : IAsyncEnumerable<TResult>, IEnumerable<TResult>
//     where T : class
//     where TResult : class
...
//     internal FluentFind(Collection<T, TId> collection, Filter<T> filter, IFindManyOptions<T, TSort> findOptions, CommandOptions commandOptions)
//     {
//         _filter = filter;
...
//     /// </code>
//     /// </example>
//     public FluentFind<T, TId, TResult, TSort> Project(IProjectionBuilder projection)
//     {
...
//     /// </code>
//     /// </example>
//     public FluentFind<T, TId, TResult, TSort> Sort(TSort sortBuilder)
//     {
...
//     /// <returns>The FluentFind instance to continue specifying the find options.</returns>
//     public FluentFind<T, TId, TResult, TSort> Limit(int limit)
//     {
...
//     /// <returns>The FluentFind instance to continue specifying the find options.</returns>
//     public FluentFind<T, TId, TResult, TSort> Skip(int skip)
//     {
...
//     /// </code>
//     /// </example>
//     public FluentFind<T, TId, TResult, TSort> IncludeSimilarity(bool includeSimilarity)
//     {
...
//     /// </code>
//     /// </example>
//     public FluentFind<T, TId, TResult, TSort> IncludeSortVector(bool includeSortVector)
//     {
